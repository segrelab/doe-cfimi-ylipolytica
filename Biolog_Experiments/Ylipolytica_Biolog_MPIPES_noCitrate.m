...
% Exchange Reactions
[exch_rxns,~] = findExchRxns(Ylipolytica);
...
% Remove Citrate
[~,idx_cit,~] = intersect(Ylipolytica.rxns,'EX_cit_e');
Ylipolytica.lb(idx_cit) = 0;
...
save([pwd '\Ylipolytica_BiologFBA_MPIPES_noCitrate.mat'],'carbon_name','growth_rate','growth_class')
