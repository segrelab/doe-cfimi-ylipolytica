function [rxns_idx,rxnNames] = identifyExchRxnsFromMets(model,mets)
%IDENTIFYEXCHRXNSFROMMETS Find exchange reactions from extracellular metabolite names
%
% [rxns_idx,rxn_names] = identifyExchRxnsFromMets(model,metNames)
%
%REQUIRED INPUTS
